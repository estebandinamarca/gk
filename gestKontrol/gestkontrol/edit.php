      ...
      <div class="infocontainer">       
        ...
        <hr>  
            <div>  
              ...
              <input MaxLength="10" class="required date" id="stpartdate" name="stpartdate" style="padding-left:2px;width:113px;" type="text" value="<?php echo isset($reserva)?$sarr[0]:""; ?>" />                       
              <input MaxLength="5" class="required time tiempo" id="stparttime" name="stparttime" style="width:46px;" type="text" value="<?php echo isset($reserva)?$sarr[1]:""; ?>" /> a                      
              <input MaxLength="10" class="required date" id="etpartdate" name="etpartdate" style="padding-left:2px;width:113px;" type="text" value="<?php echo isset($reserva)?$earr[0]:""; ?>" />                       
              <input MaxLength="50" class="required time tiempo" id="etparttime" name="etparttime" style="width:46px;" type="text" value="<?php echo isset($reserva)?$earr[1]:""; ?>" />
        ...
        <div>
            <label class="checkp"> 
                <input id="vehicular" name="vehicular" type="checkbox" value="1" <?php if(isset($reserva) && $reserva!=null && $reserva->gettipoReserva()=="Vehicular") {echo "checked";} ?>/>Vehicular
            </label>                 
        </div>
