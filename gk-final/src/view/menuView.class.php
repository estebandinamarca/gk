...
//****** MICHAEL########3
require_once ('src/view/reporteView.class.php');
//****** FIN MICHAEL########
	...
	public function getMenu($usuario) // el parametro generará el filtro para presentar el sistema dependiendo de los perfiles 
	{
			...
			//die();
				...
				if($usuario->getPrivilegio()>5) //developer
				{
					?>
					 <ul data-role="listview" data-inset="true" data-dividertheme="b" data-count-theme="b">
						...
						<li><a href="#calendario" data-transition="slide" class="botonVistaCalendario"><img src="src/img/agendar.png" alt="Descripcion" class="ui-li-icon iconos"><h3 class="ui-li-heading">Agendar con Calendario</h3><p class="ui-li-desc">Agregue nueva visita o Modifíquela utilizando calendario.</p></a></li>   
					</ul>
				   ...
				   <ul data-role="listview" data-inset="true" data-dividertheme="b" data-count-theme="b">
					...
					?>
					<!-- ####################### MICHAEL (privilegios 5 y 6) ##############################################################3 -->
				     <ul data-role="listview" data-inset="true" data-dividertheme="b">
						<li data-role="list-divider">Informes de Entrada y Salida del edificio</li>
						<li><a href="#reporte" data-transition="slide" id="reporte_" ><img src="src/img/modificar.png" alt="Descripcion" class="ui-li-icon iconos"><h3 class="ui-li-heading">Nuevo Reporte</h3>
						<p class="ui-li-desc">Generar un nuevo reporte.</p></a></li>
						<li><a href="#reporte-gen" data-transition="slide"><img src="src/img/validar.png" alt="Descripcion" class="ui-li-icon iconos"><h3 class="ui-li-heading">Ver Reportes generados</h3>
						<p class="ui-li-desc">Permite ver reportes almacenados en el sistema.</p></a></li>
						<li><a href="#data-online" data-transition="slide"><img src="src/img/radar.png" alt="Descripcion" class="ui-li-icon iconos"><h3 class="ui-li-heading">Ver Registros en línea</h3>
						<p class="ui-li-desc">Revisar estado actual del edificio.</p></a></li>
				    </ul>					
				    <!-- ####################### FIN MICHAEL ##############################################################3 -->
				...
				<?php 
					...
					<!-- ####################### MICHAEL (privilegios 5 y 6) ##############################################################3 -->
				     <ul data-role="listview" data-inset="true" data-dividertheme="b">
						<li data-role="list-divider">Informes de Entrada y Salida del edificio</li>
						<li><a href="#reporte" data-transition="slide"><img src="src/img/modificar.png" alt="Descripcion" class="ui-li-icon iconos"><h3 class="ui-li-heading">Nuevo Reporte</h3>
						<p class="ui-li-desc">Generar un nuevo reporte.</p></a></li>
						<li><a href="#reporte-gen" data-transition="slide"><img src="src/img/validar.png" alt="Descripcion" class="ui-li-icon iconos"><h3 class="ui-li-heading">Ver Reportes generados</h3>
						<p class="ui-li-desc">Permite ver reportes almacenados en el sistema.</p></a></li>
						<li><a href="#data-online" data-transition="slide"><img src="src/img/radar.png" alt="Descripcion" class="ui-li-icon iconos"><h3 class="ui-li-heading">Ver Registros en línea</h3>
		...
		switch($usuario->getPrivilegio())
		{
			...
			case 3: // cliente
				...
				gestionMensajeriaView::viewMensaje();
				gestionMensajeriaView::nuevoMensaje($usuario->getIdUsuario());*/
				gestionClienteView::geteditarEstacionamientosDivConfig();
			...
			case 4: //Administrador de clientes 
				...
				//-----CALENDARIO------
				gestionCalendarioView::vistasCalendario();
				//-----CALENDARIO------
