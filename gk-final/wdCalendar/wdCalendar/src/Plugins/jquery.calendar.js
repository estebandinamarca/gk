...
; (function($) {
    ...
    $.fn.bcalendar = function(option) {
        ...
        function buildtempdayevent(sh, sm, eh, em, h, title, w, resize, thindex) {
        	 //alert(sh+"_"+sm+"_"+em+"_"+h+"_"+thindex);
            ...
            if (data != null) {
                if (option.quickDeleteUrl != "" && data[8] == 1 && option.readonly != true) {
                    var csbuddle = '<div id="bbit-cs-buddle" style="z-index: 180; width: 400px;visibility:hidden;" class="bubble"><table class="bubble-table" cellSpacing="0" cellPadding="0"><tbody><tr><td class="bubble-cell-side"><div id="tl1" class="bubble-corner"><div class="bubble-sprite bubble-tl"></div></div><td class="bubble-cell-main"><div class="bubble-top"></div><td class="bubble-cell-side"><div id="tr1" class="bubble-corner"><div class="bubble-sprite bubble-tr"></div></div>  <tr><td class="bubble-mid" colSpan="3"><div style="overflow: hidden" id="bubbleContent1"><div><div></div><div class="cb-root"><table class="cb-table" cellSpacing="0" cellPadding="0"><tbody><tr><td class="cb-value"><div class="textbox-fill-wrapper"><div class="textbox-fill-mid"><div id="bbit-cs-what" title="'
                    	+ i18n.xgcalendar.click_to_detail + '" class="textbox-fill-div lk-test" style="cursor:pointer;"></div></div></div></td></tr><tr><td class=cb-value><div id="bbit-cs-buddle-timeshow"></div></td></tr></tbody></table><div class="bbit-cs-split"><input id="bbit-cs-id" type="hidden" value=""/><span id="bbit-cs-delete" class="lk">'
        ...
        function quickadd(start, end, isallday, pos,estacion) {
            ...
            if (buddle.length == 0) {
                ...
                var temparr = [];
                temparr.push('<div id="bbit-cal-buddle" style="z-index: 999; width: 400px;visibility:hidden;" class="bubble">');
                ...
                temparr.push(i18n.xgcalendar.content, '</th><td class="cb-value"><div class="textbox-fill-wrapper"><div class="textbox-fill-mid"><input id="bbit-cal-what" class="textbox-fill-input" type="hidden"/></div></div><div class="cb-example">');
                temparr.push(i18n.xgcalendar.example, '</div></td></tr></tbody></table><input id="bbit-cal-start" type="hidden"/><input id="estacionamientoRQ" type="hidden" value="todos"/><input id="bbit-cal-end" type="hidden"/><input id="bbit-cal-allday" type="hidden"/><input id="bbit-cal-quickAddBTN" type="hidden" value="');
                temparr.push(i18n.xgcalendar.create_event, '" type="button"/>&nbsp; <SPAN id="bbit-cal-editLink" class="lk">');
                temparr.push(i18n.xgcalendar.update_detail, ' </SPAN></div></div></div><tr><td><div id="bl1" class="bubble-corner"><div class="bubble-sprite bubble-bl"></div></div><td><div class="bubble-bottom"></div><td><div id="br1" class="bubble-corner"><div class="bubble-sprite bubble-br"></div></div></tr></tbody></table><div id="bubbleClose1" class="bubble-closebutton"></div><div id="prong2" class="prong"><div class=bubble-sprite></div></div></div>');
                //alert(document.getElementById("select-choice-min").value);
                var tempquickAddHanler = temparr.join("");
                temparr = null;
                $(document.body).append(tempquickAddHanler);
                //$("#bbit-cal-end").val("asdflk");
                //alert($("#bbit-cal-end").val());
                ...
                lbtn.click(function(e) {
                    ...
                    if (!option.EditCmdhandler) {
                        ...
                        if (option.EditCmdhandler && $.isFunction(option.EditCmdhandler)) {
                            option.EditCmdhandler.call(this, ['0', $("#bbit-cal-what").val(), $("#bbit-cal-start").val(), $("#bbit-cal-end").val(),$("#bbit-cal-allday").val(), $("#estacionamientoRQ").val()]);
                        }
                        $("#bbit-cal-buddle").css("visibility", "hidden");
                        realsedragevent();
                    }
            ...
            $("#estacionamientoRQ").val(estacion);
        ...
        function dragMove(e) {
            if (_dragdata) {
                if (e.pageX < 0 || e.pageY < 0
					...
					|| e.pageY >= document.documentElement.clientHeight+200) {
                    dragEnd(e);
                    return false;
                }
                var d = _dragdata;
            ...
            if (_dragdata) {
                ...
                switch (d.type) {
                    case 1: //day view
                        ...
                        //alert('dragend');
                        var estacion=document.getElementById("select-choice-min").value;
                       // alert(estacion);
                        quickadd(start, end, false, pos,estacion);
                        break;
                    case 2: //week view
                    case 3: //month view					
                        var source = e.srcElement || e.target;                       
                        ...
                        var estacion=document.getElementById("select-choice-min").value;
                        quickadd(start, end, true, { left: e.pageX, top: e.pageY },estacion);
                        break;
                    case 4: // event moving
                        if (d.cpwrap) {
