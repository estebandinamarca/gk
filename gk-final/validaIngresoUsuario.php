		...
		switch ($_POST)
		{
			case isset($_POST["nombreUsuario"]):
				...
				if($_POST["nombreCompletoUsuario"]!=""&&$_POST["nombreUsuario"]!=""&&$_POST["contrasenaUsuario"]!=""&&
					$_POST["contrasenaUsuarioConf"]!="") //Usuario  no esta ingresado en la DB
			
				{
					...
					if ($_POST["radioOpcion"]=="usuarioCliente")
					{
						...
						$data = array($_POST["select-empresa"],$_POST["nombreUsuario"],$_POST["nombreCompletoUsuario"],md5($_POST["contrasenaUsuario"]),null,
					...
					else 
					{
								...
								$_POST["ubicacionOperador"]!=""&&$_POST["orientacionOperador"]!="")
						{
							...
							$data = array($seguridad,$_POST["nombreUsuario"],$_POST["nombreCompletoUsuario"],md5($_POST["contrasenaUsuario"]),null,
