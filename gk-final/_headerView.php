...
?>
	<li class="menu_right principal menu-mensajes"><a id="cantCorreo"  href="#bandeja-entrada"  class="drop botonVistaMensaje"><?php if ($cont>0){?><span><?php echo $cont;?></span><?php }?></a><!-- Begin 4 columns Item -->
    ...
    $(".botonVistaCalendario").bind('tap',function (){
		 ...
		 atributo1="content-"+atributo[1]; 
		 //alert(atributo1);
		 $('#'+atributo1).load('cargadorVistasCalendario.php?do='+atributo1+'',function(){
...
?>
		...
		<li class="menu_right principal"><a href="#lista-visitas-en-espera" class="drop"><img src="src/img/time-menu.png" onClick="location.replace('index.php#lista-visitas-en-espera');"><?php if ($contVisEsp>0) {?><span class="rojo"><?php echo $contVisEsp;?></span><?php }?></a>
			<div class="dropdown_1column align_right">
	    		<div class="col_1">
	    		<ul class="greybox">
	    			<li><a href="#lista-visitas-en-espera">Visitas en espera</a></li>
	    		</ul> 
	    		</div> 
	    	</div>
		</li>
          ...
          <li class="menu_right principal menu-semana"><a href="#"><?php if ($totalVisitasSemana>0){?><span><?php echo $totalVisitasSemana;?></span><?php }?></a><!-- Begin 3 columns Item -->
              <div class="dropdown_1column align_right">
                  ...
                  <div class="col_1">
                      <ul class="greybox">
                          <li><a href="#calendario" rel="external" class="ui-link-inherit botonVistaCalendario">Total: <strong><?php echo $totalVisitasSemana;?></strong></a></li>
                      </ul>   
                  </div>
                  
                  <div class="col_1">
                      <ul class="greybox">
                          <li><a href="#calendario" rel="external" class="ui-link-inherit botonVistaCalendario">En la mañana: <strong><?php echo $visitasSemanaManana;?></strong></a></li>
                      </ul>   
                  </div>

                  <div class="col_1">
                      <ul class="greybox">
                          <li><a href="#calendario" rel="external" class="ui-link-inherit botonVistaCalendario">En la tarde: <strong><?php echo $visitasSemanaTarde;?></strong></a></li>
                      </ul>   
                  </div>
               </div>
            </li>
            <li class="menu_right principal menu-dia"><a href="#"><?php if ($totalVisitasHoy>0){?><span><?php echo $totalVisitasHoy; ?></span><?php }?></a>
              ...
              <div class="dropdown_1column align_right">
                  ...
                  <div class="col_1">
                      <ul class="greybox">
                          <li><a href="#calendario" rel="external" class="ui-link-inherit botonVistaCalendario">Total: <strong><?php echo $totalVisitasHoy; ?></strong></a></li>
                      </ul>   
                  </div>
                  
                  <div class="col_1">
                      <ul class="greybox">
                          <li><a href="#calendario" rel="external" class="ui-link-inherit botonVistaCalendario">En la mañana: <strong><?php echo $visitasHoyManana; ?></strong></a></li>
                      </ul>   
                  </div>

                  <div class="col_1">
                      <ul class="greybox">
                          <li><a href="#calendario" rel="external" class="ui-link-inherit botonVistaCalendario">En la tarde: <strong><?php echo $visitasHoyTarde; ?></strong></a></li>
                      </ul>   
                  </div>
              </div>  
          </li>
