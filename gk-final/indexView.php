      	...
      	<ul id="menu">
	      	<li class="menu_right principal imagen">
		        ...
		        <div class="dropdown_1column align_right_final">
		        	...
		        	<div class="col_1">
		        		<ul class="greybox">
		            	    <li><a href="#mi-perfil" class="botonVistaUsuario">Configuración</a></li>
		                </ul>
		                ...
		                <ul class="greybox">
		                   	<li><a href="#editar-cliente-estacionamientos" class="botonVistaUsuario" data-transition="pop" >Estacionamientos</a></li>
		                </ul>
...
// Invocadores del contenido de las vistas
	$(document).ready(function () {
		...
		if(ur.indexOf("#")>0)
		{
			...
			else if(ur.indexOf("estacionamientos")>=0)
			{
				 atributo1="content-editar-cliente-estacionamientos"; 
				//alert(atributo1);
			...
			else if(ur.indexOf("calendario")>=0)
			{
				// alert(ur);
				 atributo1="content-"+ur; 
